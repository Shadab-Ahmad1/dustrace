    ...
    <div class="row d-flex justify-content-end">
      ...
      <div class="col-md-6 d-flex justify-content-center">
        ...
        <div class="mobile-view-navbar">
          <a href="">
            ...
            <img class="shelterImage" src="/src/assets/niftyhomelogo.png"
              style="width: 135px; height: 121px; margin-top: -30px;" alt="home">
            <img class="race" src="/src/assets/race.png" style="width: 200px; margin-top: -30px; height: 40px"
              alt="home">
          </a>
        </div>
      </div>
      <div class="col-md-3 login-button">
        <div class="d-flex justify-content-end">
          <button v-if="session == undefined" key="btnAuth" class="btn" @click="login"><img
              src="/src/assets/login.png"></button>
  ...
  <section class="py-5 text-center container home">
    ...
    <div class="row py-lg-5 align-content-center justify-content-center mx-auto">
      ...
      <div class="col-lg-6 col-md-8 align-content-center justify-content-center mx-auto">
        <p class="textwhite first-image-content" id="hiddenText" v-show="showText">
          Dive into the thrilling world of horse racing within NiftyRace! Purchase your favorite horse and stable it to
          get on step closer to entering the race!
        </p>
      </div>
    </div>
    ...
    <div class="row  align-content-center justify-content-center mx-auto third-row">
