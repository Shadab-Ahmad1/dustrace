...
<div class="card mb-3">
  <div class="card-body d-flex justify-content-between profile">
    <div class="reward">
      Reward DU$T
      ...
      <div v-else class="row">
        <div class="col-md-4 col-sm-6" v-for="asset of myStaked"
          ...
          <NftCard
            ...
            <button type="button" class="btn btn-primary btn-sm" v-if="cacheSession[asset.asset_id.toString()].type == 'horse' && !cacheSession[asset.asset_id.toString()].ready"
